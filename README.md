...
## Contents
The technical level is quite basic in order to be suitable for people with little computing experience, yet it covers key topics they might find useful in working with biological data, including:
- Basics of Linux
- Python scripting
- Regular expressions
- Perl one-liners
